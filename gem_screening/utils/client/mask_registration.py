...
def register_masks_batch_client(run_id: str, mask_paths: list[Path], total_fovs: int, track_stitch_threshold: float = 0.75) -> list[str]:
    """
    Register multiple masks to Redis in batch and trigger tracking for R2 masks.
    
    Args:
        run_id (str): The run ID associated with the masks
